...
var SETUP_COMBOS={
 'mac|kind':{
  ...
  blocks:[
   ...
   {k:'hero',h:'interactive setup wizard <span class="info-tip" data-tip="Full TUI wizard — walks through cluster detection, server install, secret store, upstream and uplink bootstrap. Dev mode uses in-memory OpenBao for evaluation.">ⓘ</span>',c:'<span class="c-cm"># Interactive TUI wizard — handles install + bootstrap</span>\noberth setup'},
  ...
  tldr:['brew install oberthci/tap/oberth','oberth setup','git clone ssh://git@YOUR_HOST:30022/codeberg/your-org/your-repo.git']
 },
 'linux|k3s':{
  ...
  tldr:['curl -sfL https://get.k3s.io -o k3s-install.sh && sh k3s-install.sh --disable=traefik --write-kubeconfig-mode 644','curl -fsSL https://oberth.ci/install.sh | sh','oberth setup','git clone ssh://git@YOUR_HOST:30022/codeberg/your-org/your-repo.git']
 },
 'linux|k0s':{
  ...
  tldr:['curl -sSfL https://get.k0s.sh -o k0s-install.sh && sudo sh k0s-install.sh','sudo k0s install controller --single','sudo k0s start','sudo k0s kubeconfig admin > ~/.kube/config','curl -fsSL https://oberth.ci/install.sh | sh','oberth setup','git clone ssh://git@YOUR_HOST:30022/codeberg/your-org/your-repo.git']
 }
};

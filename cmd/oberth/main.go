...
const usageCommands = "audit, init, validate, install, upgrade, unseal, serve, upstream, repo, schedules, fragments, artifacts, runs, run, log, repos, issues, status, uplink, access, secretstore, or version"

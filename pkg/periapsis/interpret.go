...
const (
	...
	// MaxSourceBytes is the largest accepted .oberth/periapsis.go definition.
	// Callers that inspect repository declarations before creating a Job use
	// the same bound as the in-Job interpreter.
	MaxSourceBytes = 1 << 20
)
...
func sdkExports() interp.Exports {
	return interp.Exports{
		"oberth/oberth": {
			...
			"Release":         reflect.ValueOf(Release),
